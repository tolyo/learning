...
describe("digest", function () {
  ...
  it("has a $$phase field whose value is the current digest phase", function() {
    ...
    scope.$watch(
      function(scope) {scope.phaseInWatchFunction = scope.$$phase;
        return scope.aValue;
      },
      function(newValue, oldValue, scope) {
...
describe("inheritance", function() {
  ...
  it("executes $evalAsync functions on isolated scopes", function(done) {
    ...
    setTimeout(function() {expect(child.didEvalAsync).toBe(true);
      done();
    }, 50);
  });
...
describe("Events", function() {
  ...
  it('accepts expressions in $apply', function() {
    scope.aFunction = function() {return 42};
    console.log(scope.$apply('aFunction()'));
